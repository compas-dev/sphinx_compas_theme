...
# class plotfigure(nodes.General, nodes.Element):
#     pass


# def visit(self, node):
#     self.body.append("tomtom")
...
# class PlotFigureDirective(Directive):
...
#     def run(self):
#         node = self.plotfigure()
#         return [node]


# def setup(app):
#     app.add_node(plotfigure, html=(visit, depart))
#     app.add_directive('plot-figure', PlotFigureDirective)
...
class PlotFigureDirective(Directive):
    ...
    def run(self):
        ...
        self.options['class'] = 'fluid-img img-fluid'
...
# ==============================================================================
# This is the run method of the directive
# ==============================================================================
